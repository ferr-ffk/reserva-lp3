class Dicionario_Csv:
    ...
    def obter_lista_dicionarios_em_csv(caminho_arquivo: str) -> list[dict]:
        ...
        with open(caminho_arquivo, "r") as arquivo:
            for linha in arquivo:
                ...
                lista.append(Dicionario_Csv.obter_dicionario_por_linha_csv(linha))
    ...
    def obter_dicionario_por_numero_linha_csv(n: int, caminho_arquivo: str) -> dict:
        ...
        with open(caminho_arquivo, "r") as arquivo:
            ...
            for linha in arquivo:
                if i == n: 
                    return Dicionario_Csv.obter_dicionario_por_linha_csv(linha)
...
if __name__ == "__main__":
    ...
    Dicionario_Csv.salvar_dicionario_em_arquivo({
        "nome": "Davi Gomes",
        "idade": 82741,
    ...
    print(Dicionario_Csv.obter_lista_dicionarios_em_csv("teste.csv"))
